...
class WaccEstimator:
    def __init__(self, data_path, country_grids, electricity_prices, solar_results, wind_results, capex_mapping, generation_data, crp_data, irena_waccs, aures_waccs, country_codes, aures_diacore, OECD_IR, IMF_IR, GDP, collated_IR, tax_data, irena_2022, rise_data, country_mapping, economic_parameters, output_folder, land_cover, land_mapping, TIAM_regions, solar_cf, wind_cf, nominal, country_waccs_2024=None):     
        ...
        # Include overwritten cost of capital
        if country_waccs_2024 is not None:
        ...
        if nominal is not None:
            ...
            self.solar_uf_nom = self.solar_pv_uf
            self.onshore_uf_nom = self.onshore_uf 
            self.offshore_uf_nom = self.offshore_uf
        ...
        # Calculate the share of OPEX, CAPEX and Financing Costs under the uniform and country scenarios
        self.solar_lcoe = self.calculate_lcoe_shares(self.solar_lcoe)
        self.wind_lcoe = self.calculate_lcoe_shares(self.wind_lcoe)
        self.offshore_lcoe = self.calculate_lcoe_shares(self.offshore_lcoe)
